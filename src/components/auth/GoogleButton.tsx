...
export function GoogleButton({ onClick, disabled }: { onClick: () => void; disabled?: boolean }) {
  ...
  return (
    <button type="button" className={buttonClassName('secondary', 'w-full')} disabled={disabled} onClick={onClick}>
...
export function AuthSpinner() {
  return <LoaderCircle className="h-5 w-5 animate-spin text-accent" aria-hidden />;
}
